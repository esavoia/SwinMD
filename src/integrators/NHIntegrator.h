...
class NHIntegrator : public Integrator{
    /**
     **  New Data Member - 
     **/
    Double *mass_r;         // reverse atom mass
    double *vnh, *gnh, *qnh;
    double wbar, vlog, glog;
   ...
   // Double  shakeVirial[9];
     ...
     **/
    public:
    NHIntegrator(Ensemble* ensemble, SimConfiguration* simConfig);
    ~NHIntegrator();
    ...
    void write_vtMinus();
    void read_vtMinus();
    void kinetic(double &ekin, double &temp);
    void chain(double &press);
