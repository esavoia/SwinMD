...
LJForce::LJForce(Ensemble* ensemble) : Force(ensemble)
{
    #ifdef DEBUG
        DEBUGMSG("Creating LJForce ");
    #endif
...
void LJForce::long_range_correct()
{
...
void LJForce::write_force_info(ofstream& of)
{
    of << "LJ Force" << endl;
...
void LJForce::write_energy(ofstream& of)
{
