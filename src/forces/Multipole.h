...
class Multipole : public Force {
    ...
    bool doUpdate, correctSurfDipole, useConstraint, computeTorques;                 
    double *Dummy;
...
// JC    virtual string get_force_id(); // in order to comply with the cluster compiler
    ...
    void self_correct(double &selfEnergy);
